<template>
  <UCard variant="outline">
    ...
    <div class="space-y-5">
      ...
      <div class="flex items-center gap-3">
        <button
          class="inline-flex items-center gap-3 rounded-full bg-(--ui-primary) px-5 py-2.5 text-sm font-semibold text-[#163300] transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
